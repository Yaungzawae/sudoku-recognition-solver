...
from processing import process_image  # Assuming this processes the Sudoku image and returns a 9x9 grid
from sudoku_solver import solve_and_return_grid  # Assuming this solves a 9x9 Sudoku grid
# img_path = "test_photos/real.jpg"  # This should be set dynamically in your program
img_path = sys.argv[1]
...
# Initialize the grid with zeros as a 2D list of integers
...
def draw_grid():
    for row in range(GRID_SIZE):
        for col in range(GRID_SIZE):
            ...
            # Draw the number inside the cell if it's not zero
